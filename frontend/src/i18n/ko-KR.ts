export const koKR = {
    ...
    // 센트 이조 다이얼로그
    transpose_cents_title: "센트 단위로 이조",
    transpose_cents_amount: "이조량",
    transpose_cents_unit: "센트",

    // 도수 이조 다이얼로그
    transpose_degrees_title: "도 단위로 이조",
    transpose_degrees_scale: "스케일",
    transpose_degrees_amount: "이조량",
    ...
    kb_edit_transpose_cents: "센트 단위로 이조",
    kb_edit_transpose_degrees: "도 단위로 이조",
    ...
    appearance_section_basic: "기본 설정",
    appearance_section_font: "글꼴 설정",
    ...
    appearance_custom_theme: "사용자 지정 테마",
    appearance_no_custom_colors: "사용자 지정 색상 덮어쓰기가 없습니다. \"새 테마\"를 클릭하여 만드세요.",
    appearance_quick_colors: "빠른 색상 조정",
    appearance_quick_colors_hint: "자주 사용하는 색상을 여기에서 조정하세요. 모든 색상은 '색상' 탭에서 편집할 수 있습니다.",
    ...
    appearance_waveform_stroke: "파형 윤곽선",
    appearance_color_window: "창 배경",
    appearance_color_base: "기본색",
    appearance_color_panel: "패널색",
    appearance_color_surface: "서피스색",
    appearance_color_text: "텍스트색",
    appearance_color_text_muted: "보조 텍스트",
    appearance_color_highlight: "하이라이트",
    ...
    appearance_color_graph_grid_strong: "그래프 그리드 (강)",
    appearance_color_graph_grid_weak: "그래프 그리드 (약)",
