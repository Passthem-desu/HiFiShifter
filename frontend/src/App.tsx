  ...
  useEffect(() => {
    const handler = (event: Event) => {
      ...
      setMissingFileDialog({
        open: true,
        missingPath:
          typeof detail.missingPath === "string" ? detail.missingPath : "",
      });
    };
    ...
    (actionId: ActionId) => {
      switch (actionId) {
        ...
        case "edit.pasteReaper":
          window.dispatchEvent(
            new CustomEvent("hifi:editOp", { detail: { op: "pasteReaper" } }),
          );
          break;
      ...
      >
        <Dialog.Content maxWidth="620px">
          ...
          <Flex justify="end" mt="3">
            <Button
              onClick={() => dispatch(closeVocalShifterSkippedFilesDialog())}
            >
              {"OK"}
            </Button>
          </Flex>
